        ...
        <div class="card w-full max-w-xl !p-12 shadow-2xl">
            <form action="{{ route('admin.ketua_rt.store') }}" method="POST" class="space-y-10">
                ...
                <div class="flex items-center space-x-10">
                    ...
                    <div class="flex-1 group">
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full bg-gray-50 border @error('name') border-red-500 @else border-gray-200 @enderror rounded-2xl px-6 py-4 text-sm font-bold text-gray-700 focus:outline-none focus:ring-4 focus:ring-orange-500/5 focus:border-[#f07c1b] transition-all" placeholder="Sarudin Akmal">
