            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-5 text-sm font-bold text-black border-r border-gray-100 text-center">{{ $ketua->rt->nama_rt ?? '-' }}</td>
                        <td class="px-6 py-5 text-sm font-semibold text-gray-700 border-r border-gray-100">{{ $ketua->username }}</td>
                        <td class="px-6 py-5 text-sm font-semibold text-black border-r border-gray-100">{{ $ketua->nama_warga }}</td>
                        <td class="px-6 py-5">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <button type="button" onclick="openDeleteModal('{{ $ketua->nama_warga }}', {{ $ketua->id }})" class="p-1 text-gray-400 hover:text-red-600 transition-colors" title="Hapus">
