        ...
        <div class="card w-full max-w-xl !p-12 shadow-2xl">
            ...
            <form action="#" method="POST" class="space-y-8">
                ...
                <div class="flex items-center justify-end space-x-6 pt-6 border-t border-gray-50">
                    <a href="{{ route('admin.warga.edit', 1) }}" class="px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest text-gray-600 border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition-all">Batal</a>
