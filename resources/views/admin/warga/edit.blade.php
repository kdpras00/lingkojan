    ...
    <div class="card !p-12">
        <form action="{{ route('admin.warga.update', $warga->id) }}" method="POST" class="space-y-12">
            ...
            <div class="flex items-center justify-end space-x-4 pt-8 mt-4 border-t border-gray-100">
                <a href="{{ route('admin.warga.index') }}" class="px-8 py-3 rounded-none text-[11px] font-black uppercase tracking-widest text-gray-500 border-2 border-transparent hover:border-black transition-all">Batal</a>
