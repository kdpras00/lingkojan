...
<div class="space-y-8">
    ...
    <div class="card !p-12">
        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-12">
            @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                    <div class="group">
                        ...
                        <input type="text" name="nama_warga" value="{{ old('nama_warga') }}" class="w-full bg-gray-50 border @error('nama_warga') border-red-500 @else border-gray-200 @enderror rounded-2xl px-6 py-4 text-sm font-bold text-gray-700 focus:outline-none focus:ring-4 focus:ring-orange-500/5 focus:border-[#f07c1b] transition-all" placeholder="masukan nama lengkap anda...">
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="no_tlp" value="{{ old('no_tlp') }}" maxlength="15" minlength="10" pattern="0[0-9]{9,14}" inputmode="numeric" title="Nomor HP harus 10-15 digit dan diawali 0" class="w-full bg-gray-50 border @error('no_tlp') border-red-500 @else border-gray-200 @enderror rounded-2xl px-6 py-4 text-sm font-bold text-gray-700 focus:outline-none focus:ring-4 focus:ring-orange-500/5 focus:border-[#f07c1b] transition-all" placeholder="masukan no. telepon anda...">
            ...
            <div class="flex items-center justify-end space-x-4 pt-8 mt-4 border-t border-gray-100">
                <a href="{{ route('admin.users.index') }}" class="px-8 py-3 rounded-none text-[11px] font-black uppercase tracking-widest text-gray-500 border-2 border-transparent hover:border-black transition-all">Batal</a>
