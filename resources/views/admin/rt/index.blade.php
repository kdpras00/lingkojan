...
@section('title', 'Kelola Data RT')
@section('page_title', 'Kelola Data RT')
...
<div class="space-y-8">
    ...
    <div class="mb-10 flex items-center text-sm font-bold text-black px-4 md:px-0">
        ...
        <span class="text-gray-400">Data RT</span>
    </div>
    ...
    <div class="card !p-10 space-y-10">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-gray-100 pb-8">
            <div>
                <h3 class="text-2xl font-black text-black tracking-tight">Daftar RT</h3>
                <p class="text-sm text-gray-500 font-medium mt-1">Kelola data unit Rukun Tetangga (RT)</p>
            </div>
            <a href="{{ route('admin.rt.create') }}" class="bg-black text-white px-8 py-3.5 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-gray-800 transition-all shadow-lg flex items-center group">
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-5 text-sm font-bold text-black border-r border-gray-100">{{ $rt->nama_rt }}</td>
                        <td class="px-6 py-5">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <button type="button" onclick="openDeleteModal('{{ $rt->nama_rt }}', {{ $rt->id }})" class="p-1 text-gray-400 hover:text-red-600 transition-colors" title="Hapus">
...
<!-- Delete Confirmation Modal (Shared styling) -->
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-sm">
        <div class="bg-white rounded-[32px] overflow-hidden shadow-2xl border border-gray-100">
            <div class="p-10 text-center space-y-6">
                <div>
                    <h4 class="text-xl font-black text-black tracking-tight" id="modal_title">Hapus RT</h4>
                    <p class="text-sm text-gray-500 font-medium mt-3 leading-relaxed" id="modal_body">Apakah anda yakin ingin menghapus data ini?</p>
                </div>
...
<script>
    function openDeleteModal(name, id) {
        ...
        document.getElementById('delete_form').action = '/admin/rt/' + id;
