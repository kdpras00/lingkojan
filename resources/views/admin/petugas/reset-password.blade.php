        ...
        <div class="card w-full max-w-xl !p-12 shadow-2xl">
            ...
            <form action="#" method="POST" class="space-y-8">
                ...
                <div class="flex items-center justify-end space-x-6 pt-6 border-t border-gray-50">
                    <a href="{{ route('admin.petugas.edit', 1) }}" class="px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest text-gray-600 border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition-all">Batal</a>
                    <button type="button" class="bg-black text-white px-10 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-gray-800 transition-all shadow-xl flex items-center group/btn">
                        Simpan Password
