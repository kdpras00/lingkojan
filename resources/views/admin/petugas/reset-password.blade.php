        ...
        <div class="card w-full max-w-xl !p-12 shadow-2xl">
            ...
            <form action="#" method="POST" class="space-y-8">
                ...
                <div class="flex items-center justify-end space-x-6 pt-6 border-t border-gray-50">
                    <a href="{{ route('admin.petugas.edit', 1) }}" class="px-8 py-3 rounded-none text-[11px] font-black uppercase tracking-widest text-gray-500 border-2 border-transparent hover:border-black transition-all">Batal</a>
