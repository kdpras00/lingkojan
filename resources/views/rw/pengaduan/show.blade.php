                    ...
                    <div class="border border-gray-100 rounded-3xl overflow-hidden shadow-sm">
                        ...
                        <div class="p-10">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 mb-10">
                                ...
                                <div class="space-y-6">
                                    <div class="group">
                                        ...
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm">{{ $pengaduan->nomor_pengaduan }}</div>
                                    </div>
                                    <div class="group">
                                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">Tanggal Pengaduan</label>
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm">{{ $pengaduan->created_at->format('d-m-Y H:i') }}</div>
                                    </div>
                                    <div class="group">
                                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">Kategori</label>
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm">{{ $pengaduan->kategori }}</div>
                                    </div>
                                    <div class="group">
                                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">RT / RW</label>
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm">{{ $pengaduan->rt }} / {{ $pengaduan->rw }}</div>
                                    </div>
                                    <div class="group">
                                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">Status Terakhir</label>
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm uppercase">{{ $pengaduan->status }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-6">
                                    <div class="group">
                                        ...
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm">{{ $pengaduan->user->name }}</div>
                                    </div>
                                    <div class="group">
                                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">NIK</label>
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm tracking-widest">{{ $pengaduan->user->nik ?? '-' }}</div>
                                    </div>
                                    <div class="group">
                                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2 uppercase">No. Telepon</label>
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm">{{ $pengaduan->user->phone ?? '-' }}</div>
                                    </div>
                                    <div class="group">
                                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2 uppercase">Email</label>
                                        <div class="bg-gray-100 border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-semibold text-gray-600 shadow-sm">{{ $pengaduan->user->email }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="group mb-8">
                                <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">Subjek Laporan</label>
                                <div class="bg-gray-100 border border-gray-200 rounded-2xl px-6 py-4 text-sm font-semibold text-gray-700 shadow-sm leading-relaxed">
                                    {{ $pengaduan->subjek }}
                                </div>
                            </div>

                            <div class="group">
                                <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">Alamat / Isi Laporan</label>
