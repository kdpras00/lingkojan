...
<head>
    ...
    <title>@yield('title') - LingKojan RT</title>
...
<body style="margin: 0; min-height: 100vh; background: transparent;">
    <nav class="navbar-main relative">
        <div class="navbar-container">
            ...
            <div class="hidden md:flex items-center space-x-6">
                <div class="flex items-center space-x-2">
                    <a href="{{ route('rt.dashboard') }}" class="nav-link {{ Request::routeIs('rt.dashboard') ? 'active' : '' }}">Dashboard</a>
                    <a href="{{ route('rt.warga.index') }}" class="nav-link {{ Request::routeIs('rt.warga.*') ? 'active' : '' }}">Data Warga</a>
                </div>
                ...
                <div class="user-dropdown">
                    <div class="user-trigger">
                        ...
                        <span class="text-base font-semibold text-gray-700">{{ Auth::user()->name ?? 'Ketua RT' }}</span>
                    </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden absolute top-full left-0 right-0 w-full bg-white shadow-lg border-b border-gray-200 z-50 transition-all duration-300 ease-out transform -translate-y-2 opacity-0">
            <div class="px-6 py-5 space-y-3 flex flex-col">
                <a href="{{ route('rt.dashboard') }}" class="w-full py-2.5 px-4 rounded-xl nav-link {{ Request::routeIs('rt.dashboard') ? 'active bg-orange-50/50' : 'text-gray-700' }} hover:bg-orange-50 hover:text-[#f07c1b] transition-all duration-200">Dashboard</a>
                <a href="{{ route('rt.warga.index') }}" class="w-full py-2.5 px-4 rounded-xl nav-link {{ Request::routeIs('rt.warga.*') ? 'active bg-orange-50/50' : 'text-gray-700' }} hover:bg-orange-50 hover:text-[#f07c1b] transition-all duration-200">Data Warga</a>
    ...
    <script>
        ...
        <div class="mb-10 text-center md:text-left">
            <h2 class="text-3xl font-bold text-black">@yield('page_title', 'Dashboard RT')</h2>
