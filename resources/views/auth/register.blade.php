        ...
        <div class="register-card p-10 md:p-14 text-center">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input-wrapper">
                        <div class="input-container !mb-0 @error('alamat') border-red-500 @enderror">
                            <div class="icon-side">
                                <svg class="w-5 h-5 @error('alamat') text-red-400 @else text-gray-400 @enderror" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            </div>
                            <input type="text" name="alamat" placeholder="masukan alamat lengkap anda..." value="{{ old('alamat') }}" required>
                        </div>
                        @error('alamat')
                            <span class="text-xs text-red-500 font-medium mt-1.5 block text-left">{{ $message }}</span>
                        @enderror
